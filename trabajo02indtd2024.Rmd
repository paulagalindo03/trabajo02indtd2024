...
\hline
\textbf{Accesibilidad} & 1 & \frac{1}{2} & \frac{1}{1.5} & \frac{1}{1.2} & \frac{1}{0.8} \\
\textbf{Costo alquiler} & 2 & 1 & \frac{2}{1.5} & \frac{2}{1.2} & \frac{2}{0.8} \\
\textbf{Tráfico} & 1.5 & \frac{1.5}{2} & 1 & \frac{1.5}{1.2} & \frac{1.5}{0.8} \\
\textbf{Visibilidad} & 1.2 & \frac{1.2}{2} & \frac{1.2}{1.5} & 1 & \frac{1.2}{0.8} \\
\textbf{Competencia} & 0.8 & \frac{0.8}{2} & \frac{0.8}{1.5} & \frac{0.8}{1.2} & 1 \\
\end{array}
$$
...
Con solo mirarlo se puede decir que la mejor alternativa sería la ubicación A con un peso de 0.2339 y la peor es la ubicación C con un peso de 0.1464. 
...
```
**CONCLUSIÓN:** podemos concluir diciendo que la ubicación A, una zona céntrica de la ciudad, es la mejor alternativa combinando los cinco criterios evaluados para la cadena de restaurantes, con una prioridad global de 23.4% sobre las demás. Esto se debe principalmente a su buen desempeño en los criterios de tráfico (25,7%, la mejor puntuación) y competencia (25.0%). La segunda mejor opción es la ubicación E, que presenta la segunda prioridad global más alta de 21.9%, destacándose en el criterio de accesibilidad con un 26.5%. 

Se puede decir que la peor de las alternativas barajadas por la cadena es la ubicación C, la zona de oficnas, con el menor peso global de 14.6%, debido a su bajo rendimiento en la mayoría de los criterios evaluados.
...
Tras haber estudiado la situación por tres métodos distintos (Promethee, Electre y AHP), podemos ver que las tres conclusiones coinciden en que la mejor alternativa es la ubicación A, luego la decisión final de la cadena será abrir el nuevo restaurante en una zona céntrica de la ciudad de Sevilla.

Podría haber pasado que en algún método resultara una ubicación distinta. Esto se debe a que según el método que usemos para resolver un mismo problema de decisión multicriterio, con las mismas alternativas y mismos criterios, los resultados pueden variar debido a la funcionalidad y enfoque de cada uno de ellos.
