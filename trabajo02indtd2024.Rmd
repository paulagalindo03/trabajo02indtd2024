...
```
**CONCLUSIÓN:** podemos concluir diciendo que la ubicación A, una zona céntrica de la ciudad, con una prioridad global de 23.4%, es la mejor alternativa combinando los cinco criterios evaluados por la cadena de restaurante, especialmente en tráfico y competencia que son los criterios que presentan mayores pesos en dicha ubicación. Seguida de la ubicación A tenemos a ubicación E, que presenta la segunda prioridad global más alta de 21.9% donde el criterio de accesibilidad es el que proporciona mayor peso es dicha ubicación. <br> 
Se puede decir que la peor de las alternativas barajadas por la cadena es la ubicación C con el menor peso global de 14.6%.
